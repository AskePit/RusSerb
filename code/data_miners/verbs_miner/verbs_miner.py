...
def downloadVerb(verb: str) -> DownloadStatus:
    ...
    try:
        ...
        with io.open('out.txt', 'a', encoding='utf-8') as o:
            ...
            writeLine('# active & sing & male', verbal_adjective_active_sing_m)
            writeLine('# active & sing & fem', verbal_adjective_active_sing_f)
            writeLine('# active & sing & neu', verbal_adjective_active_sing_n)
            writeLine('# active & plur & male', verbal_adjective_active_plur_m)
            writeLine('# active & plur & fem', verbal_adjective_active_plur_f)
            writeLine('# active & plur & neu', verbal_adjective_active_plur_n)
            endl()

            writeLine('# passive & sing & male', verbal_adjective_passive_sing_m)
            writeLine('# passive & sing & fem', verbal_adjective_passive_sing_f)
            writeLine('# passive & sing & neu', verbal_adjective_passive_sing_n)
            writeLine('# passive & plur & male', verbal_adjective_passive_plur_m)
            writeLine('# passive & plur & fem', verbal_adjective_passive_plur_f)
            writeLine('# passive & plur & neu', verbal_adjective_passive_plur_n)
            finish()
